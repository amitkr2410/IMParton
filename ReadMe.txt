...
starting from low Q^2 ~ 0.07 GeV^2, which are based on analysis to
deep inelastic scattering data applying DGLAP equations with nonlinear
corrections. Refs. Xurong Chen et al, Int. J. Mod. Phys. E 23 (2014)
1450057 [arXiv:1306.1872v2]; Wei Zhu et al, Eur. Phys. J. Plus 131 (2016)
6 [arXiv:1404.0759v2].
...
3. Usage
The library consists of a C++ class named IMParton (look ./IMParton.h
...
are the distributions multiplied by x.
...
wzhu@phy.ecnu.edu.cn or rwang@impcas.ac.cn.
